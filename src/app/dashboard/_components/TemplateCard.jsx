...
const TemplateCard = ({ template }) => {
  return (
    <Link href={`/content/${template.slug}`}>
      <div className="p-5 shadow-md rounded-md border bg-white flex flex-col justify-center items-center gap-3 cursor-pointer hover:transition-all hover:duration-700 hover:scale-110 ">
